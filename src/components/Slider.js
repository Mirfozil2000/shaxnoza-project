  ...
  return (
    <div className='relative frame'>
      ...
      <div className='slider-buttons absolute z-[1] xs:text-lg text-2xl left-0 right-0 bottom-10 flex gap-10 m-auto w-fit'>
        <button
          onClick={prevSlide}
          className='flex items-center justify-center w-10 h-10 duration-300 border prev-btn lg:w-20 lg:h-14 bg-violet-900 text-violet-200 border-violet-200 hover:bg-gray-900 hover:text-gray-200 hover:border-gray-200'
        >
          <span>
            <BsArrowLeft />
          </span>
        ...
        <button
          onClick={nextSlide}
          className='flex items-center justify-center w-10 h-10 duration-300 border next-btn lg:w-20 lg:h-14 bg-violet-900 text-violet-200 border-violet-200 hover:bg-gray-900 hover:text-gray-200 hover:border-gray-200'
        >
          <span>
            <BsArrowRight />
          </span>
